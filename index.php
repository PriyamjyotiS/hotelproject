            ...
            <div class="booking_table d_flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						...
						<p>If you are looking at blank cassettes on the web, you may be very confused at the<br> difference in price. You may see some for as low as dui toka each.</p>
							...
							<div class="col-md-9">
								<div class="boking_table">
									<div class="row">
										...
										<div class="col-md-4">
											<div class="book_tabel_item"> 
												<a class="book_now_btn button_hover" href="room.php">Book Now</a>
											</div>
										</div>
									</div>
								</div>
			...
			while($row = mysqli_fetch_assoc($query_run)){
				 ?><div class="col-md-3" style="">
					<div class="card" style="width: 18rem;">
						  ...
						  <hr>
						   <img src="<?php echo './image/room'.$row["room_no"].'.jpg'?>" class="card-img-top" alt="...">
						
							<p class="card-text">Price: <?php echo $row["price"]; ?></p>
							<p class="card-text">Avialability: <?php echo $row["availability"]; ?> </p>
							<a href="book_room.php?room_no=<?php echo $row['room_no'].'&room_type='.$row["room_type"];?>" class="btn btn-primary">Book</a>
						  </div>
					  </div>
					</div>
